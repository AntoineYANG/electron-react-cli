...
const Install = _env_1.default.rootDir ? require('@@install').default : 0;
const Uninstall = _env_1.default.rootDir ? require('@@uninstall').default : 0;
const RunScript = _env_1.default.rootDir ? require('@@run').default : 0;
const Contribute = _env_1.default.rootDir ? require('@@contribute').default : 0;
