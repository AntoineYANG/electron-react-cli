...
const installAndSave = async (modules, scopes, tag) => {
  ...
  tasks.add([(0, view_deps_from_args_1.default)(modules), (0, diff_local_files_1.default)(), (0, install_resolved_deps_1.default)(), (0, create_links_1.default)(), (0, save_lock_file_1.default)(), (0, save_fail_msg_1.default)(), (0, save_package_json_1.default)(scopes, tag)], {
    rendererOptions: {
