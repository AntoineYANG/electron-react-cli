...
const installAll = async (isProd, scopes) => {
  ...
  tasks.add([(0, use_package_deps_1.default)(scopes, isProd), (0, diff_local_files_1.default)(), (0, install_resolved_deps_1.default)(), (0, create_links_1.default)(), (0, link_executable_1.default)(), (0, save_lock_file_1.default)(), (0, save_fail_msg_1.default)()], {
    exitOnError: true,
    concurrent: false
  });
