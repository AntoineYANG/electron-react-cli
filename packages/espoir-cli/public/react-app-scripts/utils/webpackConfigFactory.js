...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    entry:
      isEnvDevelopment && !shouldUseReactRefresh
        ? [
          ...
          resolveApp(path.join(paths.src, paths.entry)),
    ...
    output: {
      // The build folder.
      path:     isEnvProduction ? resolveApp(paths.output) : undefined,
      ...
      devtoolModuleFilenameTemplate: isEnvProduction
        ? info => path
          .relative(resolveApp(''), info.absoluteResourcePath)
          .replace(/\\/g, '/')
        : isEnvDevelopment
    ...
    resolve: {
      ...
      alias: {
        ...
        ...Object.fromEntries(
          Object.entries(appPackageJson.alias || {}).map(
            ([k, v]) => [k, path.resolve(fs.realpathSync(process.cwd()), v)]
          )
        )
      },
      plugins: [
        ...
        new ModuleScopePlugin(resolveApp(''), [
          'package.json',
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject:   true,
            template: resolveApp(paths.template),
          },
          isEnvProduction
            ? {
              minify: {
      ...
      isEnvDevelopment
        && new WatchMissingNodeModulesPlugin(path.resolve(fs.realpathSync(process.cwd()), 'node_modules')),
      isEnvProduction
      ...
      new ManifestPlugin({
        ...
        publicPath: resolveApp(paths.publicPath),
      ...
      useTypeScript
        && new ForkTsCheckerWebpackPlugin({
          ...
          resolveTypeReferenceDirectiveModule: process.versions.pnp
            ? `${__dirname}/pnpTs.js`
            : undefined,
          tsconfig:    path.resolve(fs.realpathSync(process.cwd()), 'tsconfig.json'),
          reportFiles: [
